  ...
  "exercises": [
    {
      ...
      "exemplum": null,
      "questions": [
        "Capitulum tertium incipit nova {md}, in quā tres {md} agunt: Iūlia, Mārcus, Quīntus.",
        "Iūlia {md}: 'Lalla'. Iūlia {md} est.",
        "Mārcus {md} est: 'St!'",
        "Mārcus Iūliam {md}.",
        "{md} Iūlia nōn cantat, sed {md}: 'Uhuhū!'",
        "Mārcus {md}: 'Hahahae!'",
        "Quīntus Mārcum {md} et īrātus est.",
        "Iūlia Aemiliam {md}: 'Mamma!'",
        "Aemilia {md}."
      ],
      "answers": [
        "scaenā",
    ...
    },
    {
      ...
      "questions": [
        "Mārcus {md} pulsat.",
        "Iūlia {md} et {md} vocat.",
        "Mārcus parvam {md} pulsat — fū!",
        "Iūlia {md} et {md} vocat: 'Mārce! Quīnte!'",
        "Aemilia {md} interrogat: 'Cur Iūlia plōrat?'",
        "Iūlius {md} interrogat: 'Cur Mārcus plōrat?'",
        "Iūlius {md} videt: 'Ecce fīlia mea probba!'",
        "Iūlia: 'Mārcus {md} pulsat!' <em>(pronome 1ª p.)</em>"
      ],
      "answers": [
        "Iūliam",
        "Quīntum",
    ...
    },
    {
      ...
      "exemplum": null,
      "questions": [
        "Iūlia {md}: 'Lalla'. Mārcus eam {md}.",
        "Iūlia nōn {md}, sed {md}: 'Uhuhū!'",
        "Quīntus Mārcum {md} et Mārcum {md}: 'Mārce!'",
        "Aemilia {md} et Quīntum {md}: 'Cur Iūlia plōrat?'",
        "Quīntus {md}: 'Iūlia plōrat quia Mārcus eam pulsat.' Iūlius {md}.",
        "Aemilia Iūlium {md}: 'Pater!'",
        "Iūlius {md} et Quīntum nōn {md}.",
        "Mārcus {md} et pater {md}.",
        "Iūlius puerum improbum {md}."
      ],
      "answers": [
        "cantat",
        "pulsat",
    ...
    },
    {
      ...
      "exemplum": null,
      "questions": [
        "Aemilia {md}: 'Quis mē vocat?'",
        "Quīntus {md}: 'Iūlia {md} vocat.'",
        "Aemilia Quīntum {md}: '{md} Iūlia plōrat?'",
        "Quīntus {md}: 'Iūlia plōrat, {md} Mārcus {md} pulsat.'",
        "Aemilia: 'Mārcus puer probus nōn est; Mārcus est puer {md}!'",
        "Aemilia: 'Ubi est Iūlius? Cur nōn venit?' — Mārcus: 'Pater nōn {md} est, sed Mārcus {md} est.'",
        "Quīntus Iūlium vocat. Cur Iūlius {md} nōn audit? — Iūlius {md} nōn audit, quia dormit.",
        "Iūlius nōn audit, quia {md}.",
        "Mārcus rīdet, {md} pater dormit. <em>(e-não)</em>",
        "Aemilia īrāta est. Māter fīlium {md}: tuxtax, tuxtax.",
        "Iūlius eum {md}; iam nōn {md} pater.",
        "Iūlia nōn rīdet; Iūlia puella {md} est."
      ],
      "answers": [
        "interrogat",
        "respondet",
    ...
    },
    {
      ...
      "questions": [
        "Mārcus īrātus est, …{xxl}",
        "Iūlia plōrat, …{xxl}",
        "Aemilia venit, …{xxl}",
        "Mārcus Iūliam pulsat, …{xxl}",
        "Aemilia Iūliam audit, …{xxl}",
        "Iūlius Quīntum nōn audit, …{xxl}",
        "Aemilia Mārcum verberat, …{xxl}",
        "Mārcus plōrat, …{xxl}",
        "Iūlius venit, …{xxl}"
      ],
      "answers": [
        "quia Iūlia cantat",
        "quia Mārcus eam pulsat",
        "quia Iūlia plōrat",
        "quia parva puella est",
        "quia Iūlia eam vocat",
        "quia dormit",
        "quia puer improbus est",
        "quia māter eum verberat",
        "quia Mārcum audit"
      ],
      "phraseMode": true,
      "auxilia": [
    ...
    },
    {
      ...
      "questions": [
        "{md} {md} pulsat. {md} plōrat.",
        "{md} cantat. Mārcus {md} pulsat.",
        "Mārcus {md} vocat. {md} venit.",
        "{md} {md} interrogat: 'Cur Iūlia plōrat?' — Quīntus respondet: 'Mārcus {md} pulsat. Mārcus {md} pulsat.'",
        "{md}: 'Pater dormit.' {md}: 'Mater nōn tē, sed {md} interrogat.'",
        "{md} {md} (= Iūlium) nōn videt.",
        "{md} {md} vocat: 'Pater!'",
        "{md} {md} nōn audit, quia dormit.",
        "{md} {md} verberat.",
        "{md} rīdet, et {md} {md} verberat.",
        "{md} {md} verberat (= o pai açoita o filho).",
        "Iūlius {md}, {md}, {md} et {md} videt.",
        "{md} puer {md} est. <em>(Mārcus → improbus)</em>",
        "{md} {md} pulsat. <em>(Mārcus → parvam puellam)</em>",
        "{md} {md} {md} verberat. <em>(Iūlius → puerum improbum, nom. íratus)</em>",
        "{md} est puella {md}. <em>(Iūlia → proba)</em>"
      ],
      "answers": [
        "Mārcus",
        "Iūliam",
    ...
    },
    {
      ...
      "questions": [
        "Puella {} plōrat est Iūlia.",
        "Puer {} pulsat est Mārcus.",
        "Puella {} cantat est Iūlia.",
        "Puer {} rīdet est Mārcus.",
        "Puella {} Mārcus pulsat est Iūlia.",
        "Puer {} Iūlia vocat est Mārcus? — nōn, sed Iūlius!",
        "Puella {} Aemiliam vocat est Iūlia.",
        "Puella {} māter vocat est Iūlia.",
        "Puella {} venit est Aemilia.",
        "Puer {} māter verberat est Mārcus.",
        "Puer {} venit est Iūlius.",
        "Puer {} Aemilia verberat est Mārcus.",
        "Puer {} Iūlius verberat est Mārcus.",
        "Puer {} parvam puellam pulsat improbus est.",
        "Puer {} pater verberat plōrat."
      ],
      "answers": [
        "quae",
        "quī",
    ...
    },
    {
      ...
      "questions": [
        "{md} Iūliam pulsat? — Mārcus.",
        "{md} Aemiliam vocat? — Iūlia.",
        "{md} vocat Iūlia? — Aemiliam.",
        "{md} Iūlium vocat? — Quīntus.",
        "{md} vocat Quīntus? — Iūlium.",
        "{md} venit? — Aemilia.",
        "{md} videt Iūlius? — Quīntum.",
        "{md} verberat Aemilia? — Mārcum."
      ],
      "answers": [
        "quis",
        "quis",
    ...
    },
    {
      ...
      "exemplum": null,
      "questions": [
        "Em <em>Mārcus Iūliam pulsat</em>: <em>Iūliam</em> é {lg}.",
        "Em <em>Mārcus Iūliam pulsat</em>: <em>Mārcus</em> é {lg}.",
        "Em <em>Aemilia venit</em>: <em>Aemilia</em> é {lg}; em <em>māter Aemiliam vocat</em>: <em>Aemiliam</em> é {lg}.",
        "Em <em>Mārcus Iūliam pulsat</em>, <em>Iūliam</em> é {md} e <em>Mārcus</em> é {md}.",
        "Forma acusativa de <em>Mārcus</em>: {md}.",
        "Forma acusativa de <em>Aemilia</em>: {md}.",
        "Forma nominativa de <em>Iūlium</em>: {md}.",
        "Forma nominativa de <em>Iūliam</em>: {md}.",
        "Forma acusativa de <em>puer improbus</em>: {lg}.",
        "Forma acusativa de <em>parva puella</em>: {lg}."
      ],
      "answers": [
        "accūsātīvus",
        "nōminātīvus",
