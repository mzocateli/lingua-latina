  ...
  "exercises": [
    {
      ...
      "exemplum": null,
      "questions": [
        "Iūlia est {md} Rōmāna. <em>(menina)</em>",
        "Aemilia est {md} Rōmāna. <em>(mulher)</em>",
        "Mārcus est {md} Rōmānus. <em>(menino)</em>",
        "Mārcus et Quīntus sunt {md} Rōmānī. <em>(pl.)</em>",
        "Iūlius et Mēdus et Dāvus sunt {md}; Iūlius {md} Rōmānus est.",
        "Aemilia, Dēlia, Syra sunt {md} Rōmānae; Aemilia {md} Rōmāna est."
      ],
      "answers": [
        "puella",
        "fēmina",
    ...
    },
    {
      ...
      "questions": [
        "Aemilia est {md} Mārcī. <em>(mãe)</em>",
        "Mārcus et Quīntus sunt {md} Iūliī. <em>(filhos)</em>",
        "Mārcus, Quīntus et Iūlia sunt {md} Iūliī et Aemiliae. <em>(crianças)</em>",
        "Iūlia est {md} Iūliī. <em>(filha)</em>",
        "Mārcus est {md} Iūliī. <em>(filho)</em>",
        "Iūlius est pater {md}. <em>(de Mārcus)</em>",
        "Iūlius est pater {md}. <em>(de Quīntus)</em>",
        "Aemilia est māter {md}. <em>(de Iūlia)</em>",
        "Iūlius est pater {md} et {md}. <em>(de M. e Q.)</em>",
        "Aemilia est māter {md}. <em>(de Iūlia)</em>",
        "Mārcus est fīlius {md} et {md}. <em>(de I. e A.)</em>",
        "Aemilia est māter {md}, {md} et {md}. <em>(três crianças)</em>",
        "Iūlius est pater {md}, {md} et {md}."
      ],
      "answers": [
        "māter",
        "fīliī",
    ...
    },
    {
      ...
      "questions": [
        "{md} est Mārcus? — Mārcus puer Rōmānus est. <em>(quem? m. sg.)</em>",
        "{md} est pater Mārcī? — Iūlius est pater Mārcī.",
        "{md} est māter Mārcī? — Aemilia est māter Mārcī. <em>(quem? f. sg.)</em>",
        "{md} est Iūlia? — Iūlia est puella Rōmāna.",
        "{md} sunt fīliī Iūliī? — Mārcus et Quīntus sunt fīliī Iūliī. <em>(quem? m. pl.)</em>",
        "{md} est m? — m littera est. <em>(o quê? n.)</em>",
        "{md} est familia? — Familia est Iūlius et Aemilia et līberī et servī."
      ],
      "answers": [
        "quis",
        "quis",
    ...
    },
    {
      ...
      "questions": [
        "Litterae et numerī → {xl}. <em>(usando -que)</em>",
        "Mārcus et Quīntus → {xl}.",
        "Puerī et puellae → {xl}.",
        "Fēminae et puerī → {xl}. <em>(forma com et)</em>",
        "Servī et ancillae → {xl}. <em>(com et)</em>",
        "Ūna fīlia et duo fīliī → {xxl}. <em>(natural com et)</em>"
      ],
      "answers": [
        "litterae numerīque",
        "Mārcus Quīntusque",
    ...
    },
    {
      ...
      "questions": [
        "Mēdus nōn fīlius Iūliī est, sed {md} Iūliī. <em>(escravo)</em>",
        "Dēlia est {md} Aemiliae. <em>(escrava)</em>",
        "Iūlius est {md} Mēdī; Aemilia est {md} Dēliae. <em>(senhor; senhora)</em>",
        "Mēdus et Dāvus sunt duo {md}. <em>(pl. masc.)</em>",
        "Dēlia et Syra sunt duae {md}. <em>(pl. fem.)</em>",
        "In familiā Iūliī sunt multī {md}. <em>(escravos)</em>",
        "Iūlius est dominus {md}. <em>(gen. pl.: dos escravos)</em>",
        "Aemilia est domina {md}. <em>(gen. sg. fem.: da escrava)</em>",
        "Aemilia est domina {md}. <em>(gen. pl.: das escravas)</em>",
        "Mārcus, Quīntus, Iūlia sunt {md} Iūliī et Aemiliae. <em>(crianças)</em>",
        "Iūlius est dominus {md} et pater {md}. <em>(gen. pl. m.: servōrum; gen. pl. m.: līberōrum)</em>"
      ],
      "answers": [
        "servus",
        "ancilla",
    ...
    },
    {
      ...
      "questions": [
        "Iūlius est dominus {xl}. <em>(de muitos escravos)</em>",
        "Numerus {md} magnus est. <em>(dos escravos)</em>",
        "Aemilia est domina {xl}. <em>(de muitas escravas)</em>",
        "In familiā Iūliī magnus est numerus {md} et {md}. <em>(escravos, escravas)</em>",
        "Iūlius pater est, sed nōn pater {md} et {md}. <em>(escravos/escravas — gen. pl.)</em>",
        "Iūlius pater est {md}. <em>(das crianças)</em>",
        "Aemilia māter est {md}.",
        "In Graeciā magnus numerus {md}. <em>(de ilhas)</em>",
        "In Galliā magnus numerus {md}. <em>(de rios)</em>",
        "In Italiā magnus numerus {md}. <em>(de cidades)</em>"
      ],
      "answers": [
        "multōrum servōrum",
        "servōrum",
    ...
    },
    {
      ...
      "questions": [
        "In Graeciā sunt multae īnsulae → {xxl}. <em>(magnus numerus + gen.)</em>",
        "In Africā sunt paucī fluviī → {xxl}.",
        "In Italiā sunt multa oppida → {xxl}.",
        "In familiā Iūliī sunt paucī līberī → {xxl}.",
        "{md} {md} in capitulō II sunt. <em>(multa vocabula nova)</em>",
        "{md} {md} Latīnae sunt. <em>(multae litterae)</em>",
        "{md} {md} in pāginā prīmā sunt. <em>(pauca exempla)</em>"
      ],
      "answers": [
        "magnus numerus īnsulārum",
        "parvus numerus fluviōrum",
        "magnus numerus oppidōrum",
        "parvus numerus līberōrum",
        "multa",
        "vocābula",
        "multae",
        "litterae",
    ...
    },
    {
      ...
      "questions": [
        "{md} servī in familiā Iūliī sunt? — {md} (C) servī sunt.",
        "Iūlius habet {md} fīliōs: Mārcum et Quīntum. <em>(numeral m. pl.)</em>",
        "Iūlius habet {md} ancillās: Dēliam et Syram. <em>(numeral f. pl.)</em>",
        "In Italiā sunt {md} oppida — Tūsculum, Brundisium, Ostia. <em>(numeral n. pl. = 2)</em>",
        "{md} līberī sunt in familiā? — {md} (III) līberī.",
        "Sunt {md} fīliae et {md} fīlia? Immo, ūna fīlia tantum.",
        "{md} vir est Mēdus, sed {md} virī sunt Mēdus et Dāvus. <em>(numeral m.: 1, 2)</em>",
        "{md} oppida: Sparta, Delphī, Tūsculum. <em>(numeral n. pl. = 3)</em>",
        "{md} fīliī Iūliī, {md} ancillae Aemiliae, sed {md} fīlia tantum. <em>(3 m., 2 f., 1 f.)</em>",
        "{md} oppida, {md} fluviī... immo {md} oppidum tantum. <em>(3 n., 2 m., 1 n.)</em>",
        "Iūliō sunt {md} līberī: duo fīliī et {md} fīlia. — itaque {md} fīlia tantum.",
        "{md} servī Iūliō? — {md} (M) servī. <em>(numeral indeclinável)</em>"
      ],
      "answers": [
        "Quot",
        "centum",
    ...
    },
    {
      ...
      "questions": [
        "Cornēlius interrogat: 'Quot servī sunt in familiā {md}?'  <em>(possessivo m. sg.: tua)</em>",
        "Iūlius respondet: 'In familiā {md} centum servī sunt.'",
        "Cornēlius: 'Familia {md} magna est!' <em>(tua = f. sg.)</em>",
        "Iūlius: 'Familia {md} nōn parva est.'",
        "Iūlius: 'Litterae {md} clārae sunt.' <em>(tuas — f. pl.)</em>",
        "Cornēlius: 'Litterae {md} obscūrae sunt.' <em>(meas — f. pl.)</em>",
        "Cornēlius: 'Liber {md} antīquus est, Iūlī.'  <em>(masc.: tuus)</em>",
        "Iūlius: 'Liber {md} novus est.'",
        "Cornēlius: 'Vocābula {md} pulchra sunt.' <em>(tuas n. pl.)</em>",
        "Iūlius: 'Vocābula {md}, exempla {md}, capitula {md} multa sunt.'",
        "Iūlius (puerīs): 'Librī {md} antīquī sunt.'"
      ],
      "answers": [
        "tuā",
        "meā",
    ...
    },
    {
      ...
      "exemplum": null,
      "questions": [
        "{md}, duo {md}! Ūnus liber {md} est, alter liber {md} est. <em>(ecce; livros; antigo; novo)</em>",
        "Numerus {md} parvus est, sed magnus est numerus pāginārum.",
        "{md} {md} est «Lingua Latīna».",
        "In librō sunt multae {md} et multa {md} et cētera.",
        "Numerus {md} magnus est. <em>(gen. pl.: dos capítulos)</em>",
        "{md} secundum est dē familiā Rōmānā.",
        "In paginā prīmā {md} secundī multa vocābula nova sunt.",
        "In librō sunt {md} {md}.",
        "Numerus {md} magnus est. <em>(gen. pl.: dos vocábulos)</em>",
        "ECCE, {md} {md} sunt in pāginā prīmā {md} {md}.",
        "<em>familia</em> est exemplum {md}. <em>(gen. sg.: do vocábulo)</em>"
      ],
      "answers": [
        "Ecce",
        "librī",
